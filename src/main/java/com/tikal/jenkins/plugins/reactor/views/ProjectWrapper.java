...
//
//	public ProjectWrapper(TikalReactorProject reactor, int parentBuildNumber, AbstractProject project, int nestLevel, String phaseName) {
...
//				if (cause != null) {
//					if (cause.getUpstreamProject().equals(reactor.getName()) && cause.getUpstreamBuild() == parentBuildNumber) {
//						if (result == null) {
//							return run;
//						}
